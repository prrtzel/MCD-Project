# 
# Project automation script for MCD_CPLD 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source MCD_CPLD.tcl), then you can
...
set myProject "MCD_CPLD"
set myScript "MCD_CPLD.tcl"
...
proc add_source_files {} {
   ...
   project set top "Behavioral" "glue_logic"
...
proc set_process_props {} {
   ...
   project set "Project Description" "This is the VHLD for the CPLD glue logic for the single board computer project for MCD."
   ...
   project set "Target UCF File Name" "C:/Users/gsyac/Documents/MCD/MCD Project/Rev1/VHDL/src/MCD_CPLD/constraints.ucf" -process "Lock Pins"
   ...
   project set "Work Directory" "C:/Users/gsyac/Documents/MCD/MCD Project/Rev1/VHDL/src/MCD_CPLD/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "glue_logic" -process "Generate IBIS Model"
